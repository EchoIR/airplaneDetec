...
def convert_annotation(image_id):
    ...
    out_file = open('/home/echo/EXERCISEs/airplaneDetec/yolov3/labels_orig/%s.txt'%(image_id),'w') #与此xml对应的转换后的txt，这个txt的保存完整路径
...
image_ids = open('/home/echo/EXERCISEs/airplaneDetec/yolov3/train1.txt').read().strip().split()  #如果是训练集数据打开这一行，注释下一
