...
if __name__ == '__main__':
    source_folder='/home/echo/EXERCISEs/airplaneDetec/JPEGImages/'#地址是所有图片的保存地点
    dest='/home/echo/EXERCISEs/airplaneDetec/yolov3/train1.txt' #保存train.txt的地址
    dest2='/home/echo/EXERCISEs/airplaneDetec/yolov3/test1.txt'  #保存val.txt的地址
    ...
    for file_obj in file_list:                #访问文件列表中的每一个文件
        ...
        if(file_num<=2000 and file_num>=1001):                     #保留900个文件用于训练
            #print file_num
            train_file.write(file_name+'\n')  #用于训练前900个的图片路径保存在train.txt里面，结尾加回车换行
        elif(file_num<=2400 and file_num>=2206):
